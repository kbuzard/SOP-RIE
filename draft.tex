...
Adding political uncertainty allows for positive lobbying on the equilibrium path, but this is not the only additional insight. These are most clear in the case of mean-zero uncertainty, so I will assume this throughout this section unless otherwise noted.
