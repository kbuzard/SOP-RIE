...
I assume that an external authority can ensure enforcement of the agreement in the one-shot game analyzed here.\footnote{Buzard (2015) extends the analysis to a repeated-game context and can therefore remove this restriction.} 
