...
I show in the \hyperlink{psf}{Appendix} that choosing the following political weighting function aligns the political objective function used in the current model with the PFS framework:
		    \begin{equation}
