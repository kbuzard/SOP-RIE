...
The only strategic difference between the first mover and the second mover is that the first mover faces uncertainty about whether the other legislature will break the trade agreement.
